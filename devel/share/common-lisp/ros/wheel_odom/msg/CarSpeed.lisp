...
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<CarSpeed>)))
  ...
  "28c9c8c084eba4a12182c886b442512e")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'CarSpeed)))
  "Returns md5sum for a message object of type 'CarSpeed"
  "28c9c8c084eba4a12182c886b442512e")
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<CarSpeed>)))
  ...
  (cl:format cl:nil "Header header~%~%float32 left_speed~%float32 right_speed~%float32 vx~%float32 vy~%float32 vth~%~%================================================================================~%MSG: std_msgs/Header~%# Standard metadata for higher-level stamped data types.~%# This is generally used to communicate timestamped data ~%# in a particular coordinate frame.~%# ~%# sequence ID: consecutively increasing ID ~%uint32 seq~%#Two-integer timestamp that is expressed as:~%# * stamp.sec: seconds (stamp_secs) since epoch (in Python the variable is called 'secs')~%# * stamp.nsec: nanoseconds since stamp_secs (in Python the variable is called 'nsecs')~%# time-handling sugar is provided by the client library~%time stamp~%#Frame this data is associated with~%# 0: no frame~%# 1: global frame~%string frame_id~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'CarSpeed)))
  "Returns full string definition for message of type 'CarSpeed"
  (cl:format cl:nil "Header header~%~%float32 left_speed~%float32 right_speed~%float32 vx~%float32 vy~%float32 vth~%~%================================================================================~%MSG: std_msgs/Header~%# Standard metadata for higher-level stamped data types.~%# This is generally used to communicate timestamped data ~%# in a particular coordinate frame.~%# ~%# sequence ID: consecutively increasing ID ~%uint32 seq~%#Two-integer timestamp that is expressed as:~%# * stamp.sec: seconds (stamp_secs) since epoch (in Python the variable is called 'secs')~%# * stamp.nsec: nanoseconds since stamp_secs (in Python the variable is called 'nsecs')~%# time-handling sugar is provided by the client library~%time stamp~%#Frame this data is associated with~%# 0: no frame~%# 1: global frame~%string frame_id~%~%~%"))
