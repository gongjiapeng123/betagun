...
if("TRUE" STREQUAL "TRUE")
  set(cameras_SOURCE_PREFIX /root/workspace/betagun/src/cameras)
  set(cameras_DEVEL_PREFIX /root/workspace/betagun/devel)
  set(cameras_INSTALL_PREFIX "")
  set(cameras_PREFIX ${cameras_DEVEL_PREFIX})
else()
  set(cameras_SOURCE_PREFIX "")
  set(cameras_DEVEL_PREFIX "")
  set(cameras_INSTALL_PREFIX /root/workspace/betagun/install)
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'cameras' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  Ask the maintainer 'todo <todo@gmail.com>' to fix it.")
      endif()
    else()
      message(FATAL_ERROR "Project 'cameras' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/root/workspace/betagun/src/cameras/${idir}'.  Ask the maintainer 'todo <todo@gmail.com>' to fix it.")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /root/workspace/betagun/devel/lib;/root/workspace/betagun/devel/lib;/opt/ros/indigo/lib)
...
set(cameras_EXPORTED_TARGETS "cameras_gencfg")
